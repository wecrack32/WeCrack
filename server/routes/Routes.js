...
const { registerUser,googleLoginUser, logoutUser, loginUser, userdetails, mockscore, getmockscore,addTask,getTasks, topicstracker, getTopics, addNote } = require('../controllers/user.controller');
